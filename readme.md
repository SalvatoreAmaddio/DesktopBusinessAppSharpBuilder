...
```csharp
    public Employee(DbDataReader reader) //This constructor is called when data are fetched.
    {
        ...
        _gender = new(reader.GetInt64(4)); //notice a ForeignKey Model was defined with an additional constructor taking long as argument.
        _department = new(reader.GetInt64(5)); //notice a ForeignKey Model was defined with an additional constructor taking long as argument.
        _jobTitle = new(reader.GetInt64(6)); //notice a ForeignKey Model was defined with an additional constructor taking long as argument.
